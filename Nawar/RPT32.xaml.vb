...
Public Class RPT32
    ...
    Public Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles Button2.Click
        If Flag <> 6 AndAlso Flag <> 7 AndAlso Flag <> 12 AndAlso Flag <> 2 Then
        ...
        rpt.paravalue = New String() {FromDate.SelectedDate, ToDate.SelectedDate, CType(Parent, Page).Title, Val(OrderTypeId.Text), Val(ImportMessageId.Text), Val(ImportMessageId.Text), Val(StoreId.Text), Val(StoreInvoiceNo.Text), Val(ItemId.Text), ItemName.Text, OrderTypeName.Text, ImportMessageName.Text, StoreName.Text, 0, IIf(Md.MyProjectType = ProjectType.NawarGroup, 0, 1), "", PRTFlag}
