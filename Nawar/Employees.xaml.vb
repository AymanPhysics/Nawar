...
Public Class Employees
    ...
    Private Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        Select Case Md.MyProjectType
            ...
            Case ProjectType.X9, ProjectType.X7, ProjectType.X11, ProjectType.X8 'ProjectType.ClinicWomen,
            ...
            Case ProjectType.X14, ProjectType.X17, ProjectType.X20
                Doctor.Visibility = Windows.Visibility.Hidden
                'Nurse.Visibility = Windows.Visibility.Hidden
                Receptionist.Visibility = Windows.Visibility.Hidden
                lblTax.Visibility = Windows.Visibility.Hidden
            ...
            Case ProjectType.X5, ProjectType.X6, ProjectType.X28
                Doctor.Visibility = Windows.Visibility.Hidden
                'Nurse.Visibility = Windows.Visibility.Hidden
                Receptionist.Visibility = Windows.Visibility.Hidden
                lblTax.Visibility = Windows.Visibility.Hidden
            ...
            Case ProjectType.X15, ProjectType.X15
                Doctor.Visibility = Windows.Visibility.Hidden
                'Nurse.Visibility = Windows.Visibility.Hidden
                Receptionist.Content = "مدخل بيانات"

            Case ProjectType.NawarGroup, ProjectType.X0, ProjectType.X27
                lblTax.Visibility = Windows.Visibility.Hidden
                lblTax2.Visibility = Windows.Visibility.Hidden
                Tax.Visibility = Windows.Visibility.Hidden
        ...
        Select Case Md.MyProjectType
            Case ProjectType.X3, ProjectType.X2, ProjectType.X9, ProjectType.X11, ProjectType.X7, ProjectType.X12, ProjectType.X10
                Nurse.Content = "تمريض"
            Case Else
    ...
    Private Sub btnPermissions1_Click(sender As Object, e As RoutedEventArgs) Handles btnPermissions1.Click
        bm.ShowHelpPermissions("أنواع يوميات القبض", Val(txtID.Text), "select cast(S.Id as varchar(100)) Id,S.Name,cast((case when E.EmpId is null then 0 else 1 end) as bit) Permission from View_EmpBankCash_G2Types1 E right join View_BankCash_G2Types1 S on(E.Flag=S.Flag and E.TypeId=S.Id and(EmpId=" & Val(txtID.Text) & " or EmpId is null)) ", "View_EmpBankCash_G2Types1",, {"Flag"}, {1})
    End Sub

    Private Sub btnPermissions2_Click(sender As Object, e As RoutedEventArgs) Handles btnPermissions2.Click
        bm.ShowHelpPermissions("أنواع يوميات الدفع", Val(txtID.Text), "select cast(S.Id as varchar(100)) Id,S.Name,cast((case when E.EmpId is null then 0 else 1 end) as bit) Permission from View_EmpBankCash_G2Types2 E right join View_BankCash_G2Types2 S on(E.Flag=S.Flag and E.TypeId=S.Id and(EmpId=" & Val(txtID.Text) & " or EmpId is null)) ", "View_EmpBankCash_G2Types2",, {"Flag"}, {2})
    End Sub
    Private Sub btnPermissions3_Click(sender As Object, e As RoutedEventArgs) Handles btnPermissions3.Click
        bm.ShowHelpPermissions("أنواع التسويات", Val(txtID.Text), "select cast(S.Id as varchar(100)) Id,S.Name,cast((case when E.EmpId is null then 0 else 1 end) as bit) Permission from EmpEntry2Types E right join Entry2Types S on(E.Flag=S.Flag and E.TypeId=S.Id and(EmpId=" & Val(txtID.Text) & " or EmpId is null)) ", "View_EmpEntry2Types",, {"Flag"}, {3})
    End Sub

    Private Sub btnPermissions4_Click(sender As Object, e As RoutedEventArgs) Handles btnPermissions4.Click
        bm.ShowHelpPermissions("أنواع القيود", Val(txtID.Text), "select cast(S.Id as varchar(100)) Id,S.Name,cast((case when E.EmpId is null then 0 else 1 end) as bit) Permission from EmpEntryTypes E right join EntryTypes S on(E.Flag=S.Flag and E.TypeId=S.Id and(EmpId=" & Val(txtID.Text) & " or EmpId is null)) ", "View_EmpEntryTypes4",, {"Flag"}, {4})
    End Sub
End Class
