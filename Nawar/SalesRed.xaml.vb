...
Public Class SalesRed
    ...
    Private Sub Sales_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        If Not (Md.MyProjectType = ProjectType.X15) Then
    ...
    Private Sub LoadWFH()
        ...
        If Not ((Md.MyProjectType = ProjectType.X15) AndAlso TestPurchaseOnly()) Then
    ...
    Function ReadOnlyState() As Boolean
        If Md.Manager Then
            Return False
        ElseIf Md.MyProjectType = ProjectType.X14 OrElse Md.MyProjectType = ProjectType.X1 OrElse Md.MyProjectType = ProjectType.X5 OrElse Md.MyProjectType = ProjectType.X6 Then
            Return False
        Else
            Return False
        End If
    ...
    Sub LoadAllItems()
        Try
            ...
            If Md.Receptionist AndAlso Md.MyProjectType = ProjectType.X15 Then
...
Br:
    ...
    Private Sub SaveId_LostFocus(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles SaveId.LostFocus
        bm.LostFocus(SaveId, SaveName, "select Name+' [ '+cast(dbo.Bal0(AccNo,Id,getdate(),getdate(),0,0,0) as nvarchar(100))+' ]' Name from Fn_EmpPermissions(5," & Md.UserName & ") where Id=" & SaveId.Text.Trim(), True)
    End Sub
    ...
    Sub ClearControls()
        ...
        If (Md.MyProjectType = ProjectType.X15) AndAlso TestPurchaseOnly() AndAlso Not Md.Manager Then Temp.IsChecked = True
    End Sub
