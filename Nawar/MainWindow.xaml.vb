...
Class MainWindow
    ...
    Private Sub Window_Loaded(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles MyBase.Loaded
        Try
            ...
            If Md.MyProjectType = ProjectType.X19 Then
            ...
            Select Case Md.MyProjectType
                Case ProjectType.X23
                    Md.ShowGridAccCombo = True
            End Select

            Select Case Md.MyProjectType
                Case ProjectType.X22
                    Md.RptFromToday = True
            End Select

            Select Case Md.MyProjectType
                Case ProjectType.X14, ProjectType.X12, ProjectType.X13, ProjectType.X15, ProjectType.X17, ProjectType.X4, ProjectType.X22, ProjectType.X23, ProjectType.X25, ProjectType.X26, ProjectType.X9
            ...
            Select Case Md.MyProjectType
                Case ProjectType.X15, ProjectType.NawarGroup, ProjectType.X1, ProjectType.X5, ProjectType.X6, ProjectType.X0, ProjectType.X4, ProjectType.X21, ProjectType.X3, ProjectType.X24, ProjectType.X25, ProjectType.X26, ProjectType.X22, ProjectType.X27, ProjectType.X9, ProjectType.X28
                    Md.ShowBarcode = True
            End Select

            Select Case Md.MyProjectType
                Case ProjectType.X26
            ...
            Select Case Md.MyProjectType
                Case ProjectType.X15, ProjectType.X5, ProjectType.X25
                    Md.ShowShifts = True
            End Select

            Select Case Md.MyProjectType
                Case ProjectType.X15, ProjectType.X25
                    Md.ShowShiftForEveryStore = True
            End Select

            Select Case Md.MyProjectType
                Case ProjectType.X15, ProjectType.NawarGroup
                    Md.ShowQtySub = False
            End Select

            Select Case Md.MyProjectType
                Case ProjectType.X22, ProjectType.X24, ProjectType.X25, ProjectType.X16, ProjectType.X27
                    Md.ShowPriceLists = True
            End Select

            Select Case Md.MyProjectType
                Case ProjectType.NawarGroup, ProjectType.X0, ProjectType.X20, ProjectType.X23, ProjectType.X17, ProjectType.X27
            ...
            Select Case Md.MyProjectType
                Case ProjectType.NawarGroup, ProjectType.X14, ProjectType.X16, ProjectType.X17, ProjectType.X0, ProjectType.X20, ProjectType.X3, ProjectType.X4, ProjectType.X22, ProjectType.X23, ProjectType.X24, ProjectType.X25, ProjectType.X26, ProjectType.X27, ProjectType.X28
                    Md.ShowBankCash_G = True
            End Select

            Select Case Md.MyProjectType
                Case ProjectType.NawarGroup, ProjectType.X12, ProjectType.X2, ProjectType.X3, ProjectType.X0
            ...
            Select Case Md.MyProjectType
                Case ProjectType.X12, ProjectType.X2, ProjectType.X3, ProjectType.X15, ProjectType.NawarGroup, ProjectType.X0, ProjectType.X22, ProjectType.X25, ProjectType.X26, ProjectType.X27
