...
Partial Public Class MainPage
    ...
    Private Sub LoadGFile(CurrentTab As Integer)
        ...
        Select Case Md.MyProjectType
            Case ProjectType.X9, ProjectType.X7, ProjectType.X10, ProjectType.X11, ProjectType.X12, ProjectType.X2, ProjectType.X3
                s = "buttonscreen.jpg"
            Case ProjectType.X1
                s = "buttonscreen3.jpg"
        ...
        If Md.MyProjectType = ProjectType.X13 OrElse Md.MyProjectType = ProjectType.X14 Then
        ...
        If Not Md.MyProjectType = ProjectType.X10 AndAlso Not Md.MyProjectType = ProjectType.X11 AndAlso Not Md.MyProjectType = ProjectType.X8 Then
            AddHandler LoadRadio(103, G, "Countries").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                   ...
                                                                   If Md.MyProjectType = ProjectType.X13 Then bm.SetImage(CType(frm, BasicForm).Img, "CustomerInvoicesItems.Jpg")
                                                                   sender.Tag = New MyPage With {.Content = frm}
                                                               End Sub
        ...
        If Md.MyProjectType = ProjectType.X9 OrElse Md.MyProjectType = ProjectType.X7 OrElse Md.MyProjectType = ProjectType.X10 OrElse Md.MyProjectType = ProjectType.X12 OrElse Md.MyProjectType = ProjectType.X2 OrElse Md.MyProjectType = ProjectType.X3 OrElse Md.MyProjectType = ProjectType.X8 Then
        ...
        If Md.MyProjectType = ProjectType.X11 Then
        ...
        If Md.MyProjectType = ProjectType.X12 OrElse Md.MyProjectType = ProjectType.X2 OrElse Md.MyProjectType = ProjectType.X3 OrElse Md.MyProjectType = ProjectType.X22 OrElse Md.MyProjectType = ProjectType.X25 Then
        ...
        If Md.MyProjectType = ProjectType.X9 OrElse Md.MyProjectType = ProjectType.X7 OrElse Md.MyProjectType = ProjectType.X10 OrElse Md.MyProjectType = ProjectType.X11 OrElse Md.MyProjectType = ProjectType.X12 OrElse Md.MyProjectType = ProjectType.X2 OrElse Md.MyProjectType = ProjectType.X3 OrElse Md.MyProjectType = ProjectType.X8 Then
            ...
            If Not Md.MyProjectType = ProjectType.X10 AndAlso Not Md.MyProjectType = ProjectType.X11 Then
            ...
            End If
        End If
        If Md.MyProjectType = ProjectType.X9 OrElse Md.MyProjectType = ProjectType.X12 OrElse Md.MyProjectType = ProjectType.X10 OrElse Md.MyProjectType = ProjectType.X2 OrElse Md.MyProjectType = ProjectType.X3 OrElse Md.MyProjectType = ProjectType.X8 Then
        ...
        If Md.MyProjectType = ProjectType.X9 OrElse Md.MyProjectType = ProjectType.X3 OrElse Md.MyProjectType = ProjectType.X7 Then
        ...
        If Md.MyProjectType = ProjectType.X9 OrElse Md.MyProjectType = ProjectType.X3 Then
        ...
        If Md.MyProjectType = ProjectType.X10 Then
    ...
    Private Sub LoadGClinics(CurrentTab As Integer)
        Dim G As WrapPanel = MakePanel(CurrentTab, IIf(Md.MyProjectType = ProjectType.X2 OrElse Md.MyProjectType = ProjectType.X3, "Department", "Clinics"), "reservation.jpg")
        Dim frm As UserControl
        ...
        If Md.MyProjectType = ProjectType.X10 Then
            AddHandler LoadRadio(202, G, "Patients").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                  ...
                                                                  sender.Tag = New MyPage With {.Content = frm}
                                                              End Sub
        ElseIf Md.MyProjectType = ProjectType.X9 OrElse Md.MyProjectType = ProjectType.X3 OrElse Md.MyProjectType = ProjectType.X7 Then
            AddHandler LoadRadio(203, G, "Patients Data").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                       frm = New Cases4
                                                                       sender.Tag = New MyPage With {.Content = frm}
                                                                   End Sub
        ElseIf Md.MyProjectType = ProjectType.X11 Then
        ...
        Else
            AddHandler LoadRadio(205, G, "Patients Data").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                       frm = New Cases With {.IsSub = IIf(Md.MyProjectType = ProjectType.X2, True, False)}
                                                                       sender.Tag = New MyPage With {.Content = frm}
                                                                   End Sub
        End If


        If Md.MyProjectType = ProjectType.X9 OrElse Md.MyProjectType = ProjectType.X2 OrElse Md.MyProjectType = ProjectType.X3 Then
        ...
        If Md.MyProjectType = ProjectType.X10 OrElse Md.MyProjectType = ProjectType.X8 Then
        ...
        If Md.MyProjectType = ProjectType.X2 OrElse Md.MyProjectType = ProjectType.X3 Then 'Md.MyProjectType = ProjectType.Zohor OrElse 
        ...
        If Md.MyProjectType = ProjectType.X2 OrElse Md.MyProjectType = ProjectType.X3 OrElse Md.MyProjectType = ProjectType.X9 Then
        ...
        If Not Md.MyProjectType = ProjectType.X2 AndAlso Not Md.MyProjectType = ProjectType.X3 AndAlso Not Md.MyProjectType = ProjectType.X9 Then
        ...
        If Not Md.MyProjectType = ProjectType.X2 AndAlso Not Md.MyProjectType = ProjectType.X3 AndAlso Not Md.MyProjectType = ProjectType.X11 Then
        ...
        If Md.MyProjectType = ProjectType.X2 OrElse Md.MyProjectType = ProjectType.X3 Then
        ...
        If Md.MyProjectType = ProjectType.X3 Then 'Md.MyProjectType = ProjectType.Zohor OrElse
        ...
        If Md.MyProjectType = ProjectType.X3 OrElse Md.MyProjectType = ProjectType.X9 Then
    ...
    Private Sub LoadGStores(CurrentTab As Integer)
        ...
        If Md.ShowPriceLists OrElse Md.MyProjectType = ProjectType.NawarGroup Then
        ...
        If Not Md.ShowQtySub Then
            If Not Md.MyProjectType = ProjectType.X5 AndAlso Not Md.MyProjectType = ProjectType.X6 Then
        ...
        AddHandler LoadRadio(510, G, "Items").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                               frm = New Items
                                                               If Md.MyProjectType = ProjectType.X9 OrElse Md.MyProjectType = ProjectType.X16 Then 'OrElse Md.MyProjectType = ProjectType.NawarGroup 
        ...
        If Md.MyProjectType = ProjectType.NawarGroup OrElse Md.MyProjectType = ProjectType.X22 Then
        ...
        If Md.MyProjectType = ProjectType.X12 Then str = "Donations"
        If Md.MyProjectType = ProjectType.NawarGroup Then str = "InventoryAdding"
        ...
        str = "Exchange"
        If Md.MyProjectType = ProjectType.NawarGroup Then str = "InventoryExchange"
        ...
        If Md.MyProjectType = ProjectType.NawarGroup OrElse Md.MyProjectType = ProjectType.X0 OrElse Md.MyProjectType = ProjectType.X27 Then
        ...
        If Md.MyProjectType = ProjectType.NawarGroup OrElse Md.MyProjectType = ProjectType.X24 Then
        ...
        If Md.MyProjectType = ProjectType.X9 OrElse Md.MyProjectType = ProjectType.X12 OrElse Md.MyProjectType = ProjectType.X2 OrElse Md.MyProjectType = ProjectType.X3 Then
        ...
        ElseIf Md.MyProjectType = ProjectType.X15 Then
        ...
        If Md.MyProjectType = ProjectType.X23 OrElse Md.MyProjectType = ProjectType.X24 Then
        ...
        AddHandler LoadRadio(581, G, "حجز أصناف للمبيعات").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                        frm = New Sales With {.Flag = Sales.FlagState.حجز_أصناف_للمبيعات}
                                                                        sender.Tag = New MyPage With {.Content = frm}
                                                                    End Sub
    ...
    Private Sub LoadGProduction(CurrentTab As Integer)
        ...
        AddHandler LoadRadio(614, G, "ProductionOrderCreation4").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                              frm = New OrderStatus With {.Flag = 1}
                                                                              sender.Tag = New MyPage With {.Content = frm}
                                                                          End Sub
    ...
    Private Sub LoadGSalaries(CurrentTab As Integer)
        Dim s As String = ""
        Select Case Md.MyProjectType
            Case ProjectType.X12, ProjectType.X2, ProjectType.X3
                s = "reservation.jpg"
            Case Else
                s = "MainOMEGA.jpg"
        End Select
    ...
    Private Sub LoadGAccountants(CurrentTab As Integer)
        ...
        If Md.MyProjectType = ProjectType.NawarGroup OrElse Md.MyProjectType = ProjectType.X0 OrElse Md.MyProjectType = ProjectType.X20 OrElse Md.MyProjectType = ProjectType.X23 OrElse Md.MyProjectType = ProjectType.X24 OrElse Md.MyProjectType = ProjectType.X27 Then
        ...
        If Md.MyProjectType <> ProjectType.X12 AndAlso Md.MyProjectType <> ProjectType.X2 AndAlso Md.MyProjectType <> ProjectType.X3 Then
        ...
        If Md.MyProjectType = ProjectType.X13 OrElse Md.MyProjectType = ProjectType.NawarGroup OrElse Md.MyProjectType = ProjectType.X0 OrElse Md.MyProjectType = ProjectType.X3 OrElse Md.MyProjectType = ProjectType.X23 OrElse Md.MyProjectType = ProjectType.X24 OrElse Md.MyProjectType = ProjectType.X22 Then
        ...
        If Md.MyProjectType = ProjectType.NawarGroup OrElse Md.MyProjectType = ProjectType.X0 OrElse Md.MyProjectType = ProjectType.X23 Then
        ...
        If Md.MyProjectType = ProjectType.X28 OrElse Md.MyProjectType = ProjectType.X26 OrElse Md.MyProjectType = ProjectType.X27 Then
        ...
        AddHandler LoadRadio(10112, G, "فروق العملة").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                   frm = New BankCash6
                                                                   sender.Tag = New MyPage With {.Content = frm}
                                                               End Sub
        ...
        If Md.MyProjectType = ProjectType.NawarGroup OrElse Md.MyProjectType = ProjectType.X0 OrElse Md.MyProjectType = ProjectType.X20 OrElse Md.MyProjectType = ProjectType.X23 OrElse Md.MyProjectType = ProjectType.X24 OrElse Md.MyProjectType = ProjectType.X16 OrElse Md.MyProjectType = ProjectType.X17 OrElse Md.MyProjectType = ProjectType.X27 Then
        ...
        If Md.MyProjectType = ProjectType.NawarGroup OrElse Md.MyProjectType = ProjectType.X16 OrElse Md.MyProjectType = ProjectType.X0 OrElse Md.MyProjectType = ProjectType.X24 OrElse Md.MyProjectType = ProjectType.X17 OrElse Md.MyProjectType = ProjectType.X27 Then
    ...
    Private Sub LoadGClinicsReports(CurrentTab As Integer)
        Dim G As WrapPanel = MakePanel(CurrentTab, IIf(Md.MyProjectType = ProjectType.X2 OrElse Md.MyProjectType = ProjectType.X3, "Department Reports", "Clinics Reports"), "report.jpg")
        Dim frm As UserControl
    ...
    Private Sub LoadGStoresReports(CurrentTab As Integer)
        ...
        AddHandler LoadRadio(1521, G, "حجز أصناف للمبيعات").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                         frm = New RPT6 With {.Flag = 32, .Detail = 1}
                                                                         sender.Tag = New MyPage With {.Content = frm}
                                                                     End Sub
        ...
        'AddHandler LoadRadio(1598, G, "أوامر شراء تحت التنفيذ").Checked, Sub(sender As Object, e As RoutedEventArgs)
        '                                                                     frm = New RPTFromDateToDate With {.Flag = 9}
        '                                                                     sender.Tag = New MyPage With {.Content = frm}
        '                                                                 End Sub

        AddHandler LoadRadio(1598, G, "أوامر شراء تحت التنفيذ").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                             frm = New RPT6 With {.Flag = 10, .Detail = 26}
                                                                             sender.Tag = New MyPage With {.Content = frm}
                                                                         End Sub
        ...
        If Md.MyProjectType = ProjectType.NawarGroup OrElse Md.MyProjectType = ProjectType.X0 OrElse Md.MyProjectType = ProjectType.X22 OrElse Md.MyProjectType = ProjectType.X16 Then
        ...
        If Md.MyProjectType = ProjectType.NawarGroup OrElse Md.MyProjectType = ProjectType.X0 OrElse Md.MyProjectType = ProjectType.X27 Then
            ...
            If Md.MyProjectType = ProjectType.NawarGroup OrElse Md.MyProjectType = ProjectType.X27 Then
        ...
        AddHandler LoadRadio(1599, G, "أصناف لم يتم جردها").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                         frm = New RPT12 With {.Flag = 11}
                                                                         sender.Tag = New MyPage With {.Content = frm}
                                                                     End Sub

        AddHandler LoadRadio(1599, G, "أوامر شغل لم تنتهي").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                         frm = New RPTFromDateToDate With {.Flag = 9}
                                                                         sender.Tag = New MyPage With {.Content = frm}
                                                                     End Sub
        ...
        Else
            ...
            AddHandler LoadRadio(1539, G, "Items Profit").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                       frm = New RPT6 With {.Flag = 30, .Detail = 25}
                                                                       sender.Tag = New MyPage With {.Content = frm}
                                                                   End Sub
            ...
            AddHandler LoadRadio(1545, G, "استيراد الأصناف تفصيلي").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                                 frm = New RPT6 With {.Flag = 10, .Detail = 23}
                                                                                 sender.Tag = New MyPage With {.Content = frm}
                                                                             End Sub

            AddHandler LoadRadio(1546, G, "استيراد الأصناف إجمالي").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                                 frm = New RPT6 With {.Flag = 10, .Detail = 24}
                                                                                 sender.Tag = New MyPage With {.Content = frm}
                                                                             End Sub

            AddHandler LoadRadio(1545, G, "مبيعات الأصناف تفصيلي").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                                frm = New RPT6 With {.Flag = 3, .Detail = 3}
                                                                                sender.Tag = New MyPage With {.Content = frm}
                                                                            End Sub

            AddHandler LoadRadio(1546, G, "مبيعات الأصناف إجمالي").Checked, Sub(sender As Object, e As RoutedEventArgs)
            ...
            If Md.MyProjectType = ProjectType.X0 Then
        ...
        If Md.MyProjectType = ProjectType.X15 OrElse Md.MyProjectType = ProjectType.NawarGroup OrElse Md.MyProjectType = ProjectType.X0 OrElse Md.MyProjectType = ProjectType.X3 Then
        ...
        AddHandler LoadRadio(1561, G, "رصيد مخزن بمتوسط سعر الاستيراد").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                                     frm = New RPT12 With {.Flag = 5, .ReportFlag = 4}
                                                                                     sender.Tag = New MyPage With {.Content = frm}
                                                                                 End Sub
    ...
    Private Sub LoadGAccountsReports(CurrentTab As Integer)
        ...
        If Not Md.MyProjectType = ProjectType.X1 Then
        ...
        If Md.MyProjectType = ProjectType.NawarGroup OrElse Md.MyProjectType = ProjectType.X0 OrElse Md.MyProjectType = ProjectType.X20 OrElse Md.MyProjectType = ProjectType.X4 OrElse Md.MyProjectType = ProjectType.X23 OrElse Md.MyProjectType = ProjectType.X27 Then

            If Md.MyProjectType = ProjectType.NawarGroup OrElse Md.MyProjectType = ProjectType.X0 OrElse Md.MyProjectType = ProjectType.X27 Then
                AddHandler LoadRadio(1819, G, "Invoice Motion").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                             frm = New RPT301 With {.Flag = 1}
                                                                             sender.Tag = New MyPage With {.Content = frm}
                                                                         End Sub
        ...
        Else
            ...
            If Md.MyProjectType = ProjectType.X13 OrElse Md.MyProjectType = ProjectType.X15 OrElse Md.MyProjectType = ProjectType.NawarGroup OrElse Md.MyProjectType = ProjectType.X14 OrElse Md.MyProjectType = ProjectType.X0 OrElse Md.MyProjectType = ProjectType.X3 OrElse Md.MyProjectType = ProjectType.X20 OrElse Md.MyProjectType = ProjectType.X23 Then
            ...
            If Md.MyProjectType = ProjectType.NawarGroup OrElse Md.MyProjectType = ProjectType.X23 Then
            ...
            If Md.MyProjectType = ProjectType.X26 OrElse Md.MyProjectType = ProjectType.X27 Then
            ...
            If Md.MyProjectType = ProjectType.X1 Then Return
    ...
    Private Sub LoadTabs()
        ...
        If Md.MyProjectType = ProjectType.X12 OrElse Md.MyProjectType = ProjectType.X3 OrElse Md.MyProjectType = ProjectType.X13 OrElse Md.MyProjectType = ProjectType.X14 OrElse Md.MyProjectType = ProjectType.X15 OrElse Md.MyProjectType = ProjectType.X1 OrElse Md.MyProjectType = ProjectType.X5 OrElse Md.MyProjectType = ProjectType.X6 OrElse Md.MyProjectType = ProjectType.NawarGroup OrElse Md.MyProjectType = ProjectType.X16 OrElse Md.MyProjectType = ProjectType.X17 OrElse Md.MyProjectType = ProjectType.X0 OrElse Md.MyProjectType = ProjectType.X20 OrElse Md.MyProjectType = ProjectType.X4 OrElse Md.MyProjectType = ProjectType.X22 OrElse Md.MyProjectType = ProjectType.X23 OrElse Md.MyProjectType = ProjectType.X24 OrElse Md.MyProjectType = ProjectType.X25 OrElse Md.MyProjectType = ProjectType.X26 OrElse Md.MyProjectType = ProjectType.X27 OrElse Md.MyProjectType = ProjectType.X28 Then
            LoadGAccountants(8)
        End If

        LoadGSecurity(11)

        If Md.MyProjectType = ProjectType.X12 OrElse Md.MyProjectType = ProjectType.X2 OrElse Md.MyProjectType = ProjectType.X3 OrElse Md.MyProjectType = ProjectType.X14 OrElse Md.MyProjectType = ProjectType.X15 OrElse Md.MyProjectType = ProjectType.X1 OrElse Md.MyProjectType = ProjectType.X5 OrElse Md.MyProjectType = ProjectType.X6 OrElse Md.MyProjectType = ProjectType.NawarGroup OrElse Md.MyProjectType = ProjectType.X16 OrElse Md.MyProjectType = ProjectType.X0 OrElse Md.MyProjectType = ProjectType.X4 OrElse Md.MyProjectType = ProjectType.X21 OrElse Md.MyProjectType = ProjectType.X22 OrElse Md.MyProjectType = ProjectType.X23 OrElse Md.MyProjectType = ProjectType.X24 OrElse Md.MyProjectType = ProjectType.X25 OrElse Md.MyProjectType = ProjectType.X26 OrElse Md.MyProjectType = ProjectType.X27 OrElse Md.MyProjectType = ProjectType.X9 OrElse Md.MyProjectType = ProjectType.X28 Then
