...
Public Class Entry2
    ...
    Private Sub Value1_LostFocus(sender As Object, e As RoutedEventArgs) Handles Value1.LostFocus
        Try
            ...
            If CurrencyId2.SelectedValue = 1 Then
    ...
    Private Sub Value2_LostFocus(sender As Object, e As RoutedEventArgs) Handles Value2.LostFocus
        Try
            ...
            If CurrencyId1.SelectedValue = 1 Then
                Value1.Text = Value.Text
            End If
        Catch ex As Exception
        End Try
    End Sub
    ...
    Private Sub CurrencyId2_SelectionChanged(sender As Object, e As RoutedEventArgs) Handles CurrencyId2.SelectionChanged
        Return
        If lop OrElse lv Then Return
        If Val(Value2.Text) > 0 Then Return
        Try
    ...
    Private Sub ImportMessageId_LostFocus(sender As Object, e As RoutedEventArgs) Handles ImportMessageId.LostFocus
        ...
        If Val(ImportMessageId.Text) > 0 AndAlso bm.IF_Exists("select dbo.GetAccName(AccNo) from ImportMessages  where OrderTypeId='" & PurchaseAccNo.Text & "' and Id=" & Val(ImportMessageId.Text) & " and (IsDelivered=0 or DeliveredDate<'" & bm.ToStrDate(DayDate.SelectedDate) & "')") Then
            bm.ShowMSG("تاريخ الاستلام يسبق تاريخ الحركة")
            ImportMessageId.Text = ""
            ImportMessageName.Text = ""
        End If
    End Sub
