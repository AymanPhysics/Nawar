...
Namespace EmployeeTracker
    ...
    Partial Public Class Banner
        ...
        Public Sub New()
            ...
            If Not (Md.MyProjectType = ProjectType.NawarGroup AndAlso (Md.UserCanRecieve1 OrElse Md.UserCanRecieve2)) Then
                t3.Stop()
            End If
        End Sub

        Public Sub Tick()
            If Md.CompanyName Is Nothing Then Return
            ...
            Try
                '"                " &
                lblMain.Text = Md.CompanyName.ToString.Split(vbCrLf)(0) & " " & Md.UdlName.Replace("Connect", "")
