...
Br:
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        If bm.ShowDeleteMSG() Then
            ...
            bm.ExecuteNonQuery("EqualizationDeleteData", New String() {"StoreId", "InvoiceNo", "InInvoiceNo", "OutInvoiceNo"}, New String() {StoreId.Text, InvoiceNo.Text, InInvNo.Text, OutInvNo.Text})
