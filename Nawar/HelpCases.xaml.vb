...
Public Class HelpCases
    ...
    Private Sub btnSave_Click(sender As Object, e As RoutedEventArgs) Handles btnSave.Click
        ...
        If Not bm.AddItemToTable(tbl, {"Name", "EnName", "NationalId", "HomePhone", IIf(Md.MyProjectType = ProjectType.X2 OrElse Md.MyProjectType = ProjectType.X3, "Age", "Mobile"), "Address", "AccNo"}, {txtArName.Text, txtEnName.Text, NationalId.Text, txtTel.Text, txtMob.Text, txtAddress.Text, StrAccNo}) Then Return
