...
Public Class ReservationsClinics
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles btnSave.Click, btnSaveWithoutPrint.Click
        ...
        If Not Md.MyProjectType = ProjectType.X9 AndAlso Not MyProjectType = ProjectType.X7 AndAlso Not MyProjectType = ProjectType.X10 AndAlso Not MyProjectType = ProjectType.X11 AndAlso Not Canceled.IsChecked AndAlso Not Returned.IsChecked AndAlso sender Is btnSave Then ShowRPT()
