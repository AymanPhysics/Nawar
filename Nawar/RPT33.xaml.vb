...
Public Class RPT33
    ...
    Private Sub CaseId_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles CaseId.KeyUp
        ...
        Select Case Flag
            Case 1, 2
                ...
                End If
            Case Else
                If bm.ShowHelpCases(CaseId, CaseName, e, Md.MyProjectType = ProjectType.X9) Then
                    CaseID_LostFocus(sender, Nothing)
                End If
        End Select
    End Sub
    ...
    Private Sub CaseID_LostFocus(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles CaseId.LostFocus
        Select Case Flag
            ...
            Case Else
                bm.LostFocus(CaseId, CaseName, "select Name from Cases where Id=" & CaseId.Text.Trim() & IIf(Md.MyProjectType = ProjectType.X9, " and InOut=1", ""))
        End Select
    End Sub
