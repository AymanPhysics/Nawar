...
Public Class LabTests
    ...
    Private Sub Sales_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        If Md.MyProjectType <> ProjectType.X12 AndAlso Md.MyProjectType <> ProjectType.X3 Then
    ...
    Sub FillControls()
        ...
        bm.FillControls(Me)
        CaseID_LostFocus(Nothing, Nothing)
        If Not Md.MyProjectType = ProjectType.X10 Then RInvoiceNo_LostFocus(Nothing, Nothing)
