...
Public Class RPT6
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles Button2.Click
        ...
        Select Case Detail
            ...
            Case 1
                rpt.Rpt = "Sales_N.rpt"
            Case 2
                rpt.Rpt = IIf(Md.MyProjectType = ProjectType.NawarGroup, "DeletedSales_N.rpt", "DeletedSales.rpt")
            Case 3
                rpt.Rpt = "ItemsSales5.rpt"
            Case 4
                rpt.Rpt = IIf(Md.MyProjectType = ProjectType.NawarGroup, "SalesProfit_N.rpt", "SalesProfit.rpt")
                rpt.Rpt = IIf(Md.MyProjectType = ProjectType.X22, "SalesProfit_R.rpt", "SalesProfit.rpt")
            Case 5
            ...
            Case 23
                rpt.Rpt = "ItemsSales19_5.rpt"
            Case 24
                rpt.Rpt = "ItemsSales19_52.rpt"
            Case 25
                rpt.Rpt = "SalesItemsProfit.rpt"
            Case 26
                rpt.Rpt = "PuchaseOrders.rpt"
        End Select
        rpt.Show()
    End Sub
    ...
    Private Sub UserControl_Loaded(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles MyBase.Loaded
        ...
        If Not (Md.MyProjectType = ProjectType.X9 AndAlso (Detail = 0 OrElse Detail = 1)) Then
        ...
        If (Flag = 3 OrElse Flag = 30 OrElse Flag = 9 OrElse Flag = 31 OrElse Flag = 28 OrElse Flag = 32) AndAlso (Detail = 0 OrElse Detail = 1) Then
        ...
        If Not (Detail = 4 OrElse Detail = 7 OrElse Detail = 13 OrElse Detail = 18 OrElse Detail = 25) Then
        ...
        If Flag = 10 Then
            lblCountryId.Content = " ***** بلد المورد ***** "
        End If
    End Sub
    ...
    Private Sub LoadCbo()
        ...
        Select Case Flag
            ...
            Case 32
                dt.Rows.Add(New String() {32, "حجز أصناف للمبيعات"})
        ...
        Select Case Flag
            Case 2, 3, 30, 9, 28, 4, 10, 8, 21, 31, 32, 7
            Case Else
                lblToId.Visibility = Visibility.Hidden
                ToId.Visibility = Visibility.Hidden
                ToName.Visibility = Visibility.Hidden
    ...
    Private Sub ToId_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles ToId.KeyUp
        ...
        ElseIf Flag = 3 OrElse Flag = 8 OrElse Flag = 5 OrElse Flag = 30 OrElse Flag = 9 OrElse Flag = 31 OrElse Flag = 32 Then
            tbl = "Customers"
            Title = "العملاء"
            bm.ShowHelp(Title, ToId, ToName, e, "select cast(Id as varchar(100)) Id,Name from " & tbl)
        ElseIf Flag = 11 Then
