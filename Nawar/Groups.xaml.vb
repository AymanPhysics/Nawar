...
Public Class Groups
    ...
    Public Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        ElseIf Md.MyProjectType = ProjectType.X12 OrElse Md.MyProjectType = ProjectType.X2 OrElse Md.MyProjectType = ProjectType.X3 Then
            CheckBox1.Content = "مستهلكات"
        End If

        If Not Md.MyProjectType = ProjectType.X9 AndAlso Not Md.MyProjectType = ProjectType.X7 AndAlso Not Md.MyProjectType = ProjectType.X10 AndAlso Not Md.MyProjectType = ProjectType.X11 AndAlso Not Md.MyProjectType = ProjectType.X12 AndAlso Not Md.MyProjectType = ProjectType.X2 AndAlso Not Md.MyProjectType = ProjectType.X3 Then bm.SetImage(Img, "attchmentfile.jpg")

        If Md.MyProjectType = ProjectType.X21 OrElse Md.MyProjectType = ProjectType.X9 Then
