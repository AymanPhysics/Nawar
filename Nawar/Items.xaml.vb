...
Public Class Items
    ...
    Private Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        If Not Md.MyProjectType = ProjectType.X12 Then
            IsKidneysWash.Visibility = Windows.Visibility.Hidden
        End If

        If Not (Md.MyProjectType = ProjectType.X12 OrElse Md.MyProjectType = ProjectType.X2 OrElse Md.MyProjectType = ProjectType.X3 OrElse Md.MyProjectType = ProjectType.X9) Then
        ...
        If Md.MyProjectType = ProjectType.NawarGroup OrElse Md.MyProjectType = ProjectType.X4 Then
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If Md.MyProjectType = ProjectType.NawarGroup AndAlso ItemUnitId.SelectedIndex < 1 Then
            bm.ShowMSG("برجاء تحديد الوحدة")
            ItemUnitId.Focus()
            Return
        End If

        If Md.MyProjectType = ProjectType.NawarGroup AndAlso Val(CountryId.Text) = 0 Then
        ...
        bm.ExecuteNonQuery("ChangeItemName", {"Id", "NewName"}, {Val(txtID.Text), txtName.Text})
    ...
    Private Sub ItemType_SelectionChanged(ByVal sender As System.Object, ByVal e As System.Windows.Controls.SelectionChangedEventArgs) Handles ItemType.SelectionChanged
        ...
        If ItemType.SelectedIndex = 3 AndAlso Md.MyProjectType = ProjectType.NawarGroup Then
