...
Public Class Reservations
    ...
    Private Sub UserControl_Loaded(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles MyBase.Loaded
        ...
        If Md.MyProjectType = ProjectType.X3 Then btnAddCase.Visibility = Windows.Visibility.Hidden
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles btnSave.Click, btnSaveWithoutPrint.Click
        ...
        If Not Md.MyProjectType = ProjectType.X9 AndAlso Val(SerialId.Text) > 0 And Val(Payed.Text) = 0 Then
        ...
        If Not MyProjectType = ProjectType.X7 AndAlso Not MyProjectType = ProjectType.X11 AndAlso Not Canceled.IsChecked AndAlso Not Returned.IsChecked AndAlso sender Is btnSave Then ShowRPT()
    ...
    Private Sub CurrentShift_TextChanged(sender As Object, e As TextChangedEventArgs) Handles CurrentShift.TextChanged
        If Not Md.MyProjectType = ProjectType.X9 Then Return
