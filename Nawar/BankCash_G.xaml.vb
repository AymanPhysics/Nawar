...
Public Class BankCash_G
    ...
    Private Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        If Not Md.MyProjectType = ProjectType.X28 Then
    ...
    Private Sub LoadWFH()
        ...
        If (Md.MyProjectType = ProjectType.NawarGroup OrElse Md.MyProjectType = ProjectType.X0 OrElse Md.MyProjectType = ProjectType.X27) AndAlso (Flag = 2 OrElse Flag = 4) Then
    ...
    Private Sub BankId_LostFocus(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles BankId.LostFocus
        ...
        Else
            If Not lop AndAlso Md.MyProjectType <> ProjectType.X3 Then
    ...
    Private Sub CalcBalSub(i As Integer)
        If Not lop AndAlso Val(G.Rows(i).Cells(GC.SubAccNo).Value) > 0 AndAlso Md.MyProjectType <> ProjectType.X3 Then
