...
Public Class Stores
    ...
    Public Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        ElseIf Md.MyProjectType = ProjectType.X12 OrElse Md.MyProjectType = ProjectType.X2 OrElse Md.MyProjectType = ProjectType.X3 OrElse Md.MyProjectType = ProjectType.X9 Then
